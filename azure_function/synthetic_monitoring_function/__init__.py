...
def _get_page_metrics(driver, url, is_dom_complete):
    try:
        ...
        dimensions = {"region": REGEION, "url": url} 
...
def _get_driver():
    try:
        ...
        options.binary_location = "/home/site/wwwroot/syn-mon-2/chromium"
...
def _send_data(data, is_metrics=True):
    try:
        ...
        if not response.ok:
            logging.info("Error occurred while sending data logs -- yotam:")
            # TODO
            pass
    except Exception as e:
        logging.info("Error occurred while sending data logs -- yotam: {}".format(e))
        # TODO
        pass
